...
legend2 = legend(ah, [p4, p5, p6],'our strategy, \lambda_p=13, d=40','greedy strategy, \lambda_p=13, d=40',"equal probability strategy, \lambda_p=13, d=40");

%legend(ax2, 'our strategy, \lambda_p=13, d=40','greedy strategy, \lambda_p=13, d=40',"equal probability strategy, \lambda_p=13, d=40")
       
xlabel(ax1, 'Maximum number of vehicles in VFC');
ylabel(ax1, 'Long-term reward');