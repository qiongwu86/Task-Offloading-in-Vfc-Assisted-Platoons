...
figure(1);
t=begin:1:endNum;
plot(t,  discounted_SMDP5, '-r^','linewidth',2);
hold on
plot(t,  GA_unif5, '-bd','linewidth',2);
hold on
plot(t,  Equa_unif5, '-g>','linewidth',2);


plot(t,  discounted_SMDP6, '--r^','linewidth',2);
hold on
plot(t,  GA_unif6, '--bd','linewidth',2);
hold on
plot(t,  Equa_unif6, '--g>','linewidth',2);

legend('our strategy5','greedy strategy5',"equal probability strategy5", ...
       'our strategy6','greedy strategy6',"equal probability strategy6");
